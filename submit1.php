...
//This gets all the other information from the form
 ...
 $basicSalary= $_POST['basicSalary'] ; //9
 $basicSalaryMonth= $_POST['basicSalaryMonth'] ; //9
 $dearness= $_POST['dearness'] ; //10
 ...
 $basicSalaryMonthOld = $_POST['basicSalaryMonthOld'];
