...
<body>
	...
	<div id="page-wrap">
		<div id="">
			...
			require("db.php");
			//$id =$_REQUEST['C329'];
			$result = mysqli_query($conn, "SELECT * FROM annexure2018_19 INNER JOIN fy2018_19 ON annexure2018_19.C329 = fy2018_19.emp_id WHERE annexure2018_19.sr BETWEEN 504 AND 683");
