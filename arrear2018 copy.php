...
<div class="clearfix"></div>
				...
				<table border="2" cellpadding="0" width="100%" id="table2">
                            ...
                            <tr>
                                ...
                                <td style="width:40%">
                                कब से <input type="text" size="15" name="date1" id="date1">
								कब तक <input type="text" size="15" name="date2" id="date2">
								कुल दिनों की संख्या <input type="text" size="8" id="days" name="days"></td></tr>
                                <tr>
