...
<head>
	...
	<title>Schedule Income Tax: Vidhan Sabha Arrear Bill</title>
...
<body>
	...
	<div id="page-wrap">
		...
		<div id="">
              ...
              <tr>
              <td >
										<p style="text-align:center; font-size:22px">उत्तर प्रदेश विधान सभा सचिवालय, लखनऊ।		<br /><p>
							</td>
...
की मोहर
						...
						<td style="width:80%">
							...
							<p style="font-size:22px">माह 01.01.2016 से 31.12.2016 के सातवें वेतन का अंतर, जिसका भुगतान जुलाई, 2018
									को देय है, से की गयी IT से सम्बन्धी कटौतियों का शिड्यूल</p><br />
		...
		<table id="myTable">
		  ...
		  <tr border="1px">
		      ...
		      <th style="width:15%">Amount Received</th>
					<th style="width:15%">Principal Amount/Interest</th>
...
echo"<td bgcolor='#D4DEEE'><font color='black'>" .$incometax2019all."</font></td>";
echo"<td><font color='black'></font></td>";
echo"<td><font color='black'></font></td>";
echo "</tr>";
?>
 ...
 <br />
 शब्दों में रूपया- <span style="float:center"><input type="text" style="border:none; text-align:right" size="40" text-align="right"></span>
<br />
<br />
<br />
 <p style="float:right">
