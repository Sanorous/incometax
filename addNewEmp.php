...
<head>
        ...
        <meta charset="utf-8" />
        <title>Add New Retired Employee</title>
    ...
    <body class=" "><!-- START TOPBAR -->
        <div class='page-topbar '>
          ...
          mysql_query('SET collation_connection=utf8_general_ci');
                ...
                mysql_query("UPDATE employees SET ID_NO='$ID_NO_save', EMP_NM='$EMP_NM_save', DESIG='$DESIG_save', PPF_NO='$PPF_NO_save', PPF_BANK='$PPF_BANK_save', PF_NO='$PF_NO_save', PRAN_NO= '$PRAN_NO_save' WHERE ID_NO = '$id'")
                or die(mysql_error());
                echo "Saved!";
                header("Location: addNewEmp.php?ID_NO=");
                }
                mysql_close($conn);
                ?>
				...
				<div class="col-lg-12">
                        ...
                        <section class="">
                            ...
                            <div class="content-body">
                                <!-- START -->
                                <form action="add_employee_new.php" method="POST" enctype="multipart/form-data">

                                <div class='row'>
                                    <div class="col-xs-2">
                                    <label>Employee ID</label>
                                        <input type="text" class="form-control" value="<?php echo $ID_NO ?>" name="ID_NO">
                                    </div>

                                    <div class="col-xs-2">
                                    <label>Employee Name</label>
                                        <input type="text" id="transliterateTextarea" class="form-control" name="EMP_NM" value="<?php echo $EMP_NM ?>">
                                    </div>

                                    <div class="col-xs-2">
                                    <label>Designation</label>
                                        <input type="text" id="transliterateTextarea1" class="form-control" value="<?php echo $DESIG ?>" name="DESIG">
                                    </div>
