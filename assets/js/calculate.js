...
document.getElementById("total1").value = (Number(document.getElementById("basic").value) * Number(document.getElementById("months").value)).toFixed(2) * 1;
...
var calculateForm1 = function (){
  document.getElementById("totalda").value = (Number(document.getElementById("total1").value) * (Number(document.getElementById("da").value))).toFixed(2);

document.getElementById("total2").value = (Number(document.getElementById("total1").value) + Number(document.getElementById("totalda").value)).toFixed(2);
...
document.getElementById("total3").value = (Number(document.getElementById("old_basic").value) * Number(document.getElementById("months").value)).toFixed(2) * 1;

};

var calculateForm3 = function (){

  document.getElementById("totaloldda").value = (Number(document.getElementById("total3").value) * Number(document.getElementById("old_da").value)).toFixed(2);

  document.getElementById("total4").value = (Number(document.getElementById("total3").value) + Number(document.getElementById("totaloldda").value)).toFixed(2);
...
var calculateFormDiff = function (){

  document.getElementById("vetanDiff").value = (Number(document.getElementById("total1").value) - Number(document.getElementById("total3").value));

  document.getElementById("daDiff").value = (Number(document.getElementById("totalda").value) - Number(document.getElementById("totaloldda").value));

/*document.getElementById("total4").value = ((Number(document.getElementById("total3").value) + Number(document.getElementById("old_basic").value) + Number(document.getElementById("old_hra").value) +
Number(document.getElementById("old_cca").value) + Number(document.getElementById("old_gis").value) + Number(document.getElementById("old_pa").value)) / 30) * Number(document.getElementById("days").value);*/

document.getElementById("totalDiff").value = (Number(document.getElementById("vetanDiff").value) + Number(document.getElementById("daDiff").value)).toFixed(2);
};
