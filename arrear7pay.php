...
<div class="clearfix"></div>
				...
				<table border="2" cellpadding="0" width="100%" id="table2">
                            ...
                            <tr>
								...
								दिनों की संख्या <input type="text" size="8" id="days" name="days">कुल दिनों की संख्या <input type="text" size="8" id="days1" name="days1">months की संख्या <input type="text" size="8" id="months" name="months"></td></tr>
                                <tr>
      ...
      <option value="10000" data-old_hra="8200" data-old_cca="450" data-old_gis="400">10000</option>
                 ...
                 <td>बेसिक:<input type="text" name="basic" id="basic" size="8" placeholder="Basic" onblur="calculateForm()"></td>
                 <td>महंगाई: <input type="text" name="da" id="da" size="8" placeholder="D.A." onblur="calculateForm()"></td>
              ...
              <td>बेसिक:<input type="text" name="old_basic" id="old_basic" size="8" placeholder="Basic" onblur="calculateForm2()"></td>
              <td>महंगाई:<input type="text" name="old_da" id="old_da" size="8" placeholder="OLD D.A." onblur="calculateForm2()"></td>
