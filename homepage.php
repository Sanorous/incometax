...
<head>
        ...
        <meta charset="utf-8" />
        <title>Ultra Admin : User Profile</title>
		...
		else
		{
			...
			else
			{
				...
				$result =	mysqli_query($con,"SELECT * FROM employees_details WHERE Id_No = $id");
				//$password="Admin@123";
				...
				{
					header('location:login/index.html?err=1');
				}
			}
			mysqli_close($con);
		}
                    ...
                    <ul class='wraplist'>	
                        ...
                        <li class="open"> 
                            ...
                            <ul class="sub-menu" style='display:block;'>
                                ...
                                <li>
                                    <a class="active" href="ui-profile.html">Profile</a>
                                </li>
                                <li>
...
<!-- Mirrored from jaybabani.com/ultra-admin/ui-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Jun 2015 06:16:20 GMT -->
</html>
