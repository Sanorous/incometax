...
mysql_query('SET collation_connection=utf8_general_ci');
			...
			$result=mysql_query("SELECT * FROM employees ORDER BY `ID_NO` ASC");
			while($test = mysql_fetch_array($result, MYSQL_ASSOC))
			{
				$id = $test['ID_NO'];
				echo "<tr align='left'>";
				echo"<td>" .$test['ID_NO']."</td>";
				echo"<td>" .$test['EMP_NM']."</td>";
				echo"<td>" .$test['DESIG']."</td>";
			//	echo"<td>". $test['GRAD_PAY']. "</td>";
        //echo"<td>". $test['BANK_AC_NO']. "</td>";
        //echo"<form action='add_details.php?ID_NO='".$test['ID_NO'].">";
        echo"<td><input name='PRAN_NO' type='text' placeholder='PRAN Number'></td>";
        echo"<td><input name='PPF_NO' type='text' placeholder='PPF Number'></td>";
        echo"<td><input name='PF_NO' type='text' placeholder='PF Number'></td>";
				//echo"<td>". $test['Occasion_date']. "</td>";
				//echo"<td>". $test['Date']. "</td>";
				//echo"<td> <a href ='canverra.php?Id=$id'><center>Canverra</center></a>";
				echo"<td> <a href ='add_details.php?ID_NO=$id' name='save'><center>update</center></a>";
				//echo"<td> <input type='submit' name='save' value='save' /></td></form>";
				echo "</tr>";
			}
			mysql_close($conn);
			?>
