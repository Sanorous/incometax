...
google.setOnLoadCallback(onLoad);
    ...
    <body class=" "><!-- START TOPBAR -->
			...
			//$result = mysql_query("SELECT * FROM employees_details WHERE employees_details_id  = '$id'");
			//$test = mysql_fetch_array($result);
			//{

				//$id = $test['employees_details_id'];

				//echo "<tr align='center'>";
				//echo"<td width='7%'><font color='black'>" .$test['Name']."</font></td>";
			...
			?>-->
                        ...
                        <!--<tr style="border: thin groove #800000">
                            <td style="width:10%">
                                क्रमांक:-<?php echo "<font color='black' size='4px'>".$test['Id_No']."</font>"; ?>

                            </td>
                            <td style="width:25%">
                                नाम:- <?php echo "<font color='black' size='4px'>".$test['Name']."</font>"; ?>

 <input name="Name" type="text" maxlength="100" id="Name" class="hh" style="width:90%; border:thin solid #8B0707;" />
                            </td>
                            <td style="width:25%">
                                पदनाम:-<?php echo "<font color='black' size='4px'>".$test['Designation']."</font>"; ?>
                            </td>
                            <td style="width:30%">
                                Band and Grade Pay:-<?php echo "<font color='black' size='4px'>".$test['Scale']."</font>"; ?>
                            </td>
                        </tr>-->
			...
			$result=mysql_query("SELECT * FROM details WHERE ID_NO = '$id'");
...
<div class="clearfix"></div>
				...
				<table border="2" cellpadding="0" width="100%" id="table2">
                            ...
                            <tr>
                            	...
                            	<td style="width:40%">
                                Id Number<input type="text" size="20" name="Employee_Id_No" id="">
                                Bill Number<input type="text" size="20" name="bill_number" id="">
                                <span style="padding-left:100px">
                                कब से <input type="text" size="15" name="date1" id="">
								कब तक <input type="text" size="15" name="date2" id="">
								कुल दिनों की संख्या <input type="text" size="8" id="days" name="days"></span></td>
								</tr>
                                <tr>
      ...
      <option value="10000" data-old_hra="8200" data-old_cca="450" data-old_gis="400">10000</option>
                 ...
                 <td>बेसिक वेतन:<input type="text" name="basic" id="basic" size="8" placeholder="Basic" onblur="calculateForm()"></td>
                 <td>महंगाई भत्ता: <input type="text" name="da" id="da" size="8" placeholder="D.A." onblur="calculateForm()"></td>
                 <td>गृह प्रतिकार भत्ता:<input type="text" name="hra" id="hra" size="8" placeholder="H.R.A" onblur="calculateForm1()"></td>
                 <td>नगर प्रतिकार भत्ता: <input type="text" name="cca" id="cca" size="8" placeholder="C.C.A." onblur="calculateForm1()"></td>
                 <td>सामान्य भविष्य निधि:<input type="text" name="gis" id="gis" size="8" placeholder="GIS" onblur="calculateForm1()"></td>
              ...
              <td>बेसिक वेतन:<input type="text" name="old_basic" id="old_basic" size="8" placeholder="Basic" onblur="calculateForm2()"></td>
              <td>महंगाई भत्ता:<input type="text" name="old_da" id="old_da" size="8" placeholder="OLD D.A." onblur="calculateForm2()"></td>
               <td>गृह प्रतिकार भत्ता:<input type="text" name="old_hra" id="old_hra" size="8" placeholder="H.R.A" onblur="calculateForm3()"></td>
               <td>नगर प्रतिकार भत्ता:<input type="text" name="old_cca" id="old_cca" size="8" placeholder="C.C.A" onblur="calculateForm3()"></td>
               <td>सामान्य भविष्य निधि:<input type="text" name="old_gis" id="old_gis" size="8" placeholder="GIS" onblur="calculateForm3()"></td>
        ...
        <input type="text" name="total11" id="total11" size="7" placeholder="Total Old" onblur="calculateForm5()">=
            ...
            <td style="color:black; padding-right:50px; background-color:azure"> अंतर</td>
       		<td>बेसिक वेतन:<input type="text" name="diff_basic" id="diff_basic" size="8" placeholder="Basic Difference" onblur="calculateForm6()"></td>
       		<td>महंगाई भत्ता:<input type="text" name="diff_da" id="diff_da" size="8" placeholder="D.A. Difference" onblur="calculateForm6()"></td>
    		<td>गृह प्रतिकार भत्ता:<input type="text" name="diff_hra" id="diff_hra" size="8" placeholder="H.R.A Difference" onblur="calculateForm6()"></td>
        	...
        	<td>कुल अंतर:<input type="text" name="fftotal" id="fftotal" size="10" placeholder="Total Diff." onblur="calculateForm7()"></td>
        	 </tr>
	...
	<div class="col-lg-12">
                        <section class="box ">
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example-1" class="table table-striped dt-responsive display" cellspacing="0" width="100%">
                                            ...
                                            <tbody>
                                               <?php
													include("db.php");
													$result=mysql_query("SELECT * FROM calculations");
													while($test = mysql_fetch_array($result))
												{
													$id = $test['serial'];
									...
									echo"<td><font color='black'>" .$test['Employee_Id_No']."</font></td>";
									echo"<td><font color='black'>" .$test['bill_number']."</font></td>";
			...
			while($test = mysql_fetch_array($result))
			{
				...
				echo "<tr align='center'>";
				echo"<td width='7%'><font color='black'>" .$test['Employee_Id_No']."</font></td>";
