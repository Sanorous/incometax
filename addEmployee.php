...
<head>
        ...
        <meta charset="utf-8" />
        <title>Vijay Studio : Studio Manangement Application</title>
    ...
    <body class=" "><!-- START TOPBAR -->
        <div class='page-topbar '>
          ...
          mysql_query('SET collation_connection=utf8_general_ci');
                ...
                mysql_query("UPDATE employees SET EMP_NM='$EMP_NM_save', DESIG='$DESIG_save', PPF_NO='$PPF_NO_save', PPF_BANK='$PPF_BANK_save', PF_NO='$PF_NO_save', PRAN_NO= '$PRAN_NO_save' WHERE ID_NO = '$id'")
                or die(mysql_error());
                echo "Saved!";
